...
class CustomUser(AbstractUser):
    ...
    enter_email_verification_code = models.CharField(max_length=50, default=0000, null=True, blank=True,)
    ...
    phone_verification_code = models.CharField(max_length=50, default=0000, null=True, blank=True,)
